...
describe('ProductSimulator Styles', () => {
  ...
  it('should have headerTitle style', () => {
    ...
    expect(styles.headerTitle.fontSize).toBe(14);
    expect(styles.headerTitle.fontWeight).toBe('400');
    expect(styles.headerTitle.color).toBe('#757575');
